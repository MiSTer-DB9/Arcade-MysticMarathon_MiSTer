...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-MysticMarathon_MiSTer.git"
CORE_NAME=(Arcade-MysticMarathon)
...
UPSTREAM_CORE_NAME=(Arcade-MysticMarathon)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-MysticMarathon.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-MysticMarathon.rbf)
